...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Debtor Dashboard: Initializing...');
...
function updateDashboardStatistics() {
    try {
        ...
        const totalInstallments = debtsData.reduce((sum, debt) => sum + (debt.installments || 0), 0);
        ...
        // Update progress bar
        const progressPercentage = totalDebt > 0 ? Math.round((totalPaid / totalDebt) * 100) : 0;
